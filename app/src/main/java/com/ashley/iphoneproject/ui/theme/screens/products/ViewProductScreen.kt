package com.ashley.iphoneproject.ui.theme.screens.products
...
import com.ashley.iphoneproject.data.ProductViewModel
import com.ashley.iphoneproject.models.Products
import com.ashley.iphoneproject.navigation.ROUTE_UPDATE_PRODUCT
...
fun ViewProductsScreen(navController:NavHostController) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        val emptyProductState = remember { mutableStateOf(Products("","","","")) }
        val emptyProductsListState = remember { mutableStateListOf<Products>() }
